...
<head>
    ...
    <title>Your Order Has Shipped - Shoppaton Store</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="color: rgba(255, 255, 255, 0.8); font-size: 16px; line-height: 1.6; margin: 0 0 30px;">
                                Great news! Your order <strong style="color: #d4af37;">#<?php echo esc_html($order['order_number']); ?></strong> has been shipped and is on its way to you.
                            </p>
                            
                            <!-- Tracking Info Box -->
                            <div style="background: linear-gradient(135deg, rgba(212, 175, 55, 0.1), rgba(212, 175, 55, 0.05)); border: 1px solid rgba(212, 175, 55, 0.3); border-radius: 15px; padding: 25px; margin-bottom: 30px;">
                                <h2 style="color: #d4af37; font-size: 18px; margin: 0 0 15px;">📦 Tracking Information</h2>
                                
                                <table width="100%" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="color: rgba(255, 255, 255, 0.7); padding: 8px 0;">Delivery Company:</td>
                                        <td style="color: #ffffff; text-align: right; padding: 8px 0;">
                                            <?php echo esc_html($order['tracking']['delivery_company']); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: rgba(255, 255, 255, 0.7); padding: 8px 0;">Tracking Number:</td>
                                        <td style="color: #d4af37; font-weight: bold; text-align: right; padding: 8px 0;">
                                            <?php echo esc_html($order['tracking']['tracking_number']); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="color: rgba(255, 255, 255, 0.7); padding: 8px 0;">Estimated Delivery:</td>
                                        <td style="color: #ffffff; text-align: right; padding: 8px 0;">
                                            <?php echo esc_html($order['tracking']['estimated_delivery']); ?>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <div style="background: rgba(0, 0, 0, 0.3); border-radius: 15px; padding: 25px; margin-bottom: 30px;">
                                <h2 style="color: #d4af37; font-size: 18px; margin: 0 0 15px;">📍 Delivery Address</h2>
                            ...
                            <div style="background: rgba(76, 175, 80, 0.1); border-radius: 10px; padding: 20px; margin-bottom: 30px;">
                                <p style="color: #4caf50; font-size: 14px; margin: 0; text-align: center;">
                            ...
                            <p style="color: rgba(255, 255, 255, 0.6); font-size: 14px; text-align: center; margin: 0;">
                                If you have any questions about your delivery, contact us via WhatsApp or reply to this email.
                            </p>
                        </td>
                    </tr>
